...
void FastLed_Effects::dotFade(CRGB leds[], int16_t ledPosition)
{
  if(ledPosition == -1)
  {
    fadeToBlackBy( leds, _numLeds, 20);
    ...
    dotFadeHue(leds, ledPosition, _hue);
  }
}

void FastLed_Effects::dotFadeHue(CRGB leds[], int16_t ledPosition, uint8_t hue)
{
  if(ledPosition == -1)
  {
    fadeToBlackBy( leds, _numLeds, 20);
...
void FastLed_Effects::dotFadeColour(CRGB leds[], int16_t ledPosition, CRGB colour)
{
  if(ledPosition == -1)
  {
    fadeToBlackBy( leds, _numLeds, 20);
...
void FastLed_Effects::dotFadeColourWithSparkle(CRGB leds[], int16_t ledPosition, CRGB colour)
{
